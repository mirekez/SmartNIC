...
,   input wire[DATA_WIDTH/'h8-1:0] slave_in__wstrb_in
...
,   output wire[DATA_WIDTH/'h8-1:0] masters_out__wstrb_out[N]
...
;
    ...
    generate  // _assign
        ...
        for (gi='h0;gi < N;gi=gi+1) begin
            ...
            assign masters_out__wstrb_out[gi] = slave_in__wstrb_in;
