...
,   output wire[2-1:0] net_rx_almost_full_out
...
,   input wire[2-1:0] net_tx_ready_in
...
,   output wire[STREAMS*LOGICAL_ROW_BITS-1:0] debug_rx_release_row_out
    ...
    localparam  RX_READ_WIDTH = LANE_WIDTH*'h4;
    ...
    wire[2-1:0] network__rx_almost_full_out;
    ...
    wire[READ_PORTS*($clog2((BANK_DEPTH*'h4)) + 'h3)-1:0] network__read_handle_in;
    wire[READ_PORTS*$clog2((BANK_DEPTH*'h4))-1:0] network__read_word_in;
    ...
    wire[READ_PORTS*($clog2((BANK_DEPTH*'h4)) + 'h3)-1:0] network__release_handle_in;
...
,       .rx_almost_full_out(network__rx_almost_full_out)
...
,       LANE_WIDTH
    ...
    generate  // _assign
        ...
        assign net_rx_almost_full_out = network__rx_almost_full_out;
