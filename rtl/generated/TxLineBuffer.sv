...
,   input wire sop_in
,   input wire eop_in
,   input wire[PORT_WIDTH-1:0] port_in
...
,   output wire sop_out
,   output wire eop_out
,   output wire[PORT_WIDTH-1:0] port_out
,   input wire ready_in
);
    ...
    reg sop_reg[DEPTH];
    reg eop_reg[DEPTH];
    reg[PORT_WIDTH-1:0] port_reg[DEPTH];
    ...
    logic sop_comb;
    logic eop_comb;
    logic[PORT_WIDTH-1:0] port_comb;
    ...
    logic[PORT_WIDTH-1:0] port_reg_tmp[DEPTH];
    ...
    always_comb begin : port_comb_func  // port_comb_func
        port_comb = port_reg[unsigned'(32'(head_reg))];
    end
