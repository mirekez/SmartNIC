...
,   output wire protocol_error_out
    ...
    // regs and combs
    reg[64-1:0] data_bank_0[BANK_DEPTH];
    reg[8-1:0] keep_bank_0[BANK_DEPTH];
    reg[1-1:0] sop_bank_0[BANK_DEPTH];
    reg[1-1:0] eop_bank_0[BANK_DEPTH];
    reg[64-1:0] data_bank_1[BANK_DEPTH];
    reg[8-1:0] keep_bank_1[BANK_DEPTH];
    reg[1-1:0] sop_bank_1[BANK_DEPTH];
    reg[1-1:0] eop_bank_1[BANK_DEPTH];
    reg[64-1:0] data_bank_2[BANK_DEPTH];
    reg[8-1:0] keep_bank_2[BANK_DEPTH];
    reg[1-1:0] sop_bank_2[BANK_DEPTH];
    reg[1-1:0] eop_bank_2[BANK_DEPTH];
    reg[64-1:0] data_bank_3[BANK_DEPTH];
    reg[8-1:0] keep_bank_3[BANK_DEPTH];
    reg[1-1:0] sop_bank_3[BANK_DEPTH];
    reg[1-1:0] eop_bank_3[BANK_DEPTH];
    reg[64-1:0] data_bank_4[BANK_DEPTH];
    reg[8-1:0] keep_bank_4[BANK_DEPTH];
    reg[1-1:0] sop_bank_4[BANK_DEPTH];
    reg[1-1:0] eop_bank_4[BANK_DEPTH];
    reg[64-1:0] data_bank_5[BANK_DEPTH];
    reg[8-1:0] keep_bank_5[BANK_DEPTH];
    reg[1-1:0] sop_bank_5[BANK_DEPTH];
    reg[1-1:0] eop_bank_5[BANK_DEPTH];
    reg[64-1:0] data_bank_6[BANK_DEPTH];
    reg[8-1:0] keep_bank_6[BANK_DEPTH];
    reg[1-1:0] sop_bank_6[BANK_DEPTH];
    reg[1-1:0] eop_bank_6[BANK_DEPTH];
    reg[64-1:0] data_bank_7[BANK_DEPTH];
    reg[8-1:0] keep_bank_7[BANK_DEPTH];
    reg[1-1:0] sop_bank_7[BANK_DEPTH];
    reg[1-1:0] eop_bank_7[BANK_DEPTH];
...
;
    ...
    always @(posedge net_clk) begin: tx_fifo_clocked
        logic[63:0] _byte;
        logic[31:0] pop;
        logic[31:0] head;
        logic[31:0] tail;
